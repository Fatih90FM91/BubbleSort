...
// Bubble sort it's one of the easiest to learn at the beginning, so we're going to focus on this one. The main idea of a bubble sort algorithm is to sort an array using bubbles of elements. How it does that? It's underlying mechanism can be summarised as follows:
...
// Let's take an example and show how the steps are applied on a specific array. Given is the following array and we need to sort it in ascending order: 5 1 9 4 3 7
...
// Last pair in this round is 9 and 7. We see that again, 9 > 7, and switching them gives the array 1 5 4 3 7 9
